...
const FormWizard = () => {
  ...
  const validateCurrentStep = () => {
    switch (currentStep) {
      ...
      case 1: // Curriculum + Final Questions
  ...
  const handleNext = () => {
    ...
    if (nextStep === 5 && hexacoCompleted) {
      nextStep = 6; // Skip to Results step
      toast({
  ...
  const handlePrev = () => {
    ...
    if (prevStep === 5 && hexacoCompleted) {
      prevStep = 4; // Skip back to Behavioral Skills step
    }
